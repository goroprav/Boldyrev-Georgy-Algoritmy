...
v_x10 =0
y10 = 0
v_y10 = 2*np.pi*x10/(88*24*60*60)

x20 =108199995000
v_x20 = 0
y20 = 0
v_y20 = 2*np.pi*x20/(224.7*24*60*60)

x30=149599951000
v_x30=0
y30=0
v_y30=2*np.pi*x30/(365*24*60*60)

x40=227939920000
v_x40=0
y40=0
v_y40=2*np.pi*x40/(686.9*24*60*60)

x50=778330257000
v_x50=0
y50=0
v_y50=2*np.pi*x50/(11.86*365*24*60*60)

x60=1429400028000
v_x60=0
y60=0
v_y60=2*np.pi*x60/(365*24*60*60)

x70=2870989228000
v_x70=0
y70=0
v_y70=2*np.pi*x70/(365*24*60*60*29.46)

x80=4504299579000
v_x80=0
y80=0
v_y80=2*np.pi*x80/(365*24*60*84*60)
