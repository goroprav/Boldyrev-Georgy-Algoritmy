...
for i in range(len(t)-1):
    ...
    if r12 <= (R1+R2):
        ...
        V_y10 = (2 * m2 * v_y20 + v_y10 * (m1 - m2)) / (m1 + m2)
        V_y20 = (2 * m1 * v_y10 + v_y20 * (m2 - m1)) / (m1 + m2)
    else:
        V_x10 = v_x10
        V_x20 = v_x20
        V_y10 = v_y10
    ...
    if r13 <= (R1+R3):
        ...
        V_y30 = (2 * m1 * v_y10 + v_y30 * (m3 - m1)) / (m3 + m1)
        V_y10 = (2 * m3 * v_y30 + v_y10 * (m1 - m3)) / (m3 + m1)
    else:
        V_x10 = v_x10
        V_x30 = v_x30
        V_y10 = v_y10
    ...
    if r14 <= (R1+R4):
        ...
        V_y10 = (2 * m4 * v_y40 + v_y10 * (m1 - m4)) / (m1 + m4)
        V_y40 = (2 * m1 * v_y10 + v_y40 * (m4 - m1)) / (m1 + m4)
    else:
        V_x10 = v_x10
        V_x40 = v_x40
        V_y10 = v_y10
    ...
    if r15 <= (R1+R5):
        ...
        V_y10 = (2 * m5 * v_y50 + v_y10 * (m1 - m5)) / (m1 + m5)
        V_y50 = (2 * m1 * v_y10 + v_y50 * (m5 - m1)) / (m1 + m5)
    else:
        V_x10 = v_x10
        V_x50 = v_x50
        V_y10 = v_y10
    ...
    if r16 <= (R1+R6):
        ...
        V_y10 = (2 * m6 * v_y60 + v_y10 * (m1 - m6)) / (m1 + m6)
        V_y60 = (2 * m1 * v_y10 + v_y60 * (m6 - m1)) / (m1 + m6)
    else:
        V_x10 = v_x10
        V_x60 = v_x60
        V_y10 = v_y10
    ...
    if r17 <= (R1+R7):
        ...
        V_y10 = (2 * m7 * v_y70 + v_y10 * (m1 - m7)) / (m1 + m7)
        V_y70 = (2 * m1 * v_y10 + v_y70 * (m7 - m1)) / (m1 + m7)
    else:
        V_x10 = v_x10
        V_x70 = v_x70
        V_y10 = v_y10
    ...
    if r18 <= (R1+R8):
        ...
        V_y10 = (2 * m8 * v_y80 + v_y10 * (m1 - m8)) / (m1 + m8)
        V_y80 = (2 * m1 * v_y10 + v_y80 * (m8 - m1)) / (m1 + m8)
    else:
        V_x10 = v_x10
        V_x80 = v_x80
        V_y10 = v_y10
    ...
    if r19 <= (R1+R9):
        ...
        V_y10 = (2 * m9 * v_y90 + v_y10 * (m1 - m9)) / (m1 + m9)
        V_y90 = (2 * m1 * v_y10 + v_y90 * (m9 - m1)) / (m1 + m9)
    else:
        V_x10 = v_x10
        V_x90 = v_x90
        V_y10 = v_y10
    ...
    if r110 <= (R1+R10):
        ...
        V_y10 = (2 * m10 * v_y100 + v_y10 * (m1 - m10)) / (m1 + m10)
        V_y100 = (2 * m1 * v_y10 + v_y100 * (m10 - m1)) / (m1 + m10)
    else:
        V_x10 = v_x10
        V_x100 = v_x100
        V_y10 = v_y10
    ...
    if r23 <= (R2+R3):
        ...
        V_y30 = (2 * m2 * v_y20 + v_y30 * (m3 - m2)) / (m3 + m2)
        V_y20 = (2 * m3 * v_y30 + v_y20 * (m2 - m3)) / (m3 + m2)
    else:
        V_x30 = v_x30
        V_x20 = v_x20
        V_y30 = v_y30
    ...
    if r24 <= (R2+R4):
        ...
        V_y20 = (2 * m4 * v_y40 + v_y20 * (m2 - m4)) / (m2 + m4)
        V_y40 = (2 * m2 * v_y20 + v_y40 * (m4 - m2)) / (m2 + m4)
    else:
        V_x40 = v_x40
        V_x20 = v_x20
        V_y40 = v_y40
    ...
    if r25 <= (R2+R5):
        ...
        V_y20 = (2 * m5 * v_y50 + v_y20 * (m2 - m5)) / (m2 + m5)
        V_y50 = (2 * m2 * v_y20 + v_y50 * (m5 - m2)) / (m2 + m5)
    else:
        V_x50 = v_x50
        V_x20 = v_x20
        V_y50 = v_y50
    ...
    if r26 <= (R2+R6):
        ...
        V_y20 = (2 * m6 * v_y60 + v_y20 * (m2 - m6)) / (m2 + m6)
        V_y60 = (2 * m2 * v_y20 + v_y60 * (m6 - m2)) / (m2 + m6)
    else:
        V_x60 = v_x60
        V_x20 = v_x20
        V_y60 = v_y60
    ...
    if r27 <= (R2+R7):
        ...
        V_y70 = (2 * m2 * v_y20 + v_y70 * (m7 - m2)) / (m7 + m2)
        V_y20 = (2 * m7 * v_y70 + v_y20 * (m2 - m7)) / (m7 + m2)
    else:
        V_x70 = v_x70
        V_x20 = v_x20
        V_y70 = v_y70
    ...
    if r28 <= (R2+R8):
        ...
        V_y80 = (2 * m2 * v_y20 + v_y80 * (m8 - m2)) / (m8 + m2)
        V_y20 = (2 * m8 * v_y80 + v_y20 * (m2 - m8)) / (m8 + m2)
    else:
        V_x80 = v_x80
        V_x20 = v_x20
        V_y80 = v_y80
    ...
    if r29<= (R2+R9):
        ...
        V_y90 = (2 * m2 * v_y20 + v_y90 * (m9 - m2)) / (m9 + m2)
        V_y20 = (2 * m9 * v_y90 + v_y20 * (m2 - m9)) / (m9 + m2)
    else:
        V_x90 = v_x90
        V_x20 = v_x20
        V_y90 = v_y90
    ...
    if r210 <= (R2+R10):
        ...
        V_y100 = (2 * m2 * v_y20 + v_y100 * (m10- m2)) / (m10 + m2)
        V_y20 = (2 * m10 * v_y100 + v_y20 * (m2 - m10)) / (m10 + m2)
    else:
        V_x100 = v_x100
        V_x20 = v_x20
        V_y100 = v_y100
    ...
    if 34 <= (R3+R4):
        ...
        V_xy0 = (2 * m3 * v_y30 + v_y30 * (m4 - m3)) / (m4 + m3)
        V_y0 = (2 * m4 * v_y40 + v_y30 * (m3 - m4)) / (m4 + m3)
    else:
        V_x40 = v_x40
        V_x30 = v_x30
        V_y40 = v_y40
    ...
    if r35 <= (R3+R5):
        ...
        V_y50 = (2 * m3 * v_y30 + v_y50 * (m5 - m3)) / (m5 + m3)
        V_y30 = (2 * m5 * v_y50 + v_y30 * (m3 - m5)) / (m5 + m3)
    else:
        V_x50 = v_x50
        V_x30 = v_x30
        V_y50 = v_y50
    ...
    if r36 <= (R3+R6):
        ...
        V_y60 = (2 * m3 * v_y30 + v_y60 * (m6 - m3)) / (m6 + m3)
        V_y30 = (2 * m6 * v_y60 + v_y30 * (m3 - m6)) / (m6 + m3)
    else:
        V_x60 = v_x60
        V_x30 = v_x30
        V_y60 = v_y60
    ...
    if r37 <= (R3+R7):
        ...
        V_y70 = (2 * m3 * v_y30 + v_y70 * (m7 - m3)) / (m7 + m3)
        V_y30 = (2 * m7 * v_y70 + v_y30 * (m3 - m7)) / (m7 + m3)
    else:
        V_x70 = v_x70
        V_x30 = v_x30
        V_y70 = v_y70
    ...
    if r38 <= (R3+R8):
        ...
        V_y80 = (2 * m3 * v_y30 + v_y80 * (m8 - m3)) / (m8 + m3)
        V_y30 = (2 * m8 * v_y80 + v_y30 * (m3 - m8)) / (m8 + m3)
    else:
        V_x80 = v_x80
        V_x30 = v_x30
        V_y80 = v_y80
    ...
    if r39<= (R3+R9):
        ...
        V_y90 = (2 * m3 * v_y30 + v_y90 * (m9 - m3)) / (m9 + m3)
        V_y30 = (2 * m9 * v_y90 + v_y30 * (m3 - m9)) / (m9 + m3)
    else:
        V_x90 = v_x90
        V_x30 = v_x30
        V_y90 = v_y90
    ...
    if r310 <= (R3+R10):
        ...
        V_y100 = (2 * m3 * v_y30 + v_y100 * (m10- m3)) / (m10 + m3)
        V_y30 = (2 * m10 * v_y100 + v_y30 * (m3 - m10)) / (m10 + m3)
    else:
        V_x100 = v_x100
        V_x30 = v_x30
        V_y100 = v_y100
    ...
    if r45 <= (R4+R5):
        ...
        V_y50 = (2 * m4 * v_y40 + v_y50 * (m5 - m4)) / (m5 + m4)
        V_y40 = (2 * m5 * v_y50 + v_y40 * (m4 - m5)) / (m5 + m4)
    else:
        V_x50 = v_x50
        V_x40 = v_x40
        V_y50 = v_y50
    ...
    if r46 <= (R4+R6):
        ...
        V_y60 = (2 * m4 * v_y40 + v_y60 * (m6 - m4)) / (m6 + m4)
        V_y40 = (2 * m6 * v_y60 + v_y40 * (m4 - m6)) / (m6 + m4)
    else:
        V_x60 = v_x60
        V_x40 = v_x40
        V_y60 = v_y60
    ...
    if r47 <= (R4+R7):
        ...
        V_y70 = (2 * m4 * v_y40 + v_y70 * (m7 - m4)) / (m7 + m4)
        V_y30 = (2 * m7 * v_y70 + v_y40 * (m4 - m7)) / (m7 + m4)
    else:
        V_x70 = v_x70
        V_x40 = v_x40
        V_y70 = v_y70
    ...
    if r48 <= (R4+R8):
        ...
        V_y80 = (2 * m4 * v_y40 + v_y80 * (m8 - m4)) / (m8 + m4)
        V_y40 = (2 * m8 * v_y80 + v_y40 * (m4 - m8)) / (m8 + m4)
    else:
        V_x80 = v_x80
        V_x40 = v_x40
        V_y80 = v_y80
    ...
    if r49<= (R4+R9):
        ...
        V_y90 = (2 * m4 * v_y40 + v_y90 * (m9 - m4)) / (m9 + m4)
        V_y40 = (2 * m9 * v_y90 + v_y40 * (m4 - m9)) / (m9 + m4)
    else:
        V_x90 = v_x90
        V_x40 = v_x40
        V_y90 = v_y90
    ...
    if r410 <= (R4+R10):
        ...
        V_x40 = (2 * m10 * v_x100 + v_x40 * (m4 - m10)) / (m10 + m4)
        V_y100 = (2 * m4 * v_y40 + v_y100 * (m10- m4)) / (m10 + m4)
        V_y40 = (2 * m10 * v_y100 + v_y40 * (m4 - m10)) / (m10 + m4)
    else:
        V_x100 = v_x100
        V_x40 = v_x40
        V_y100 = v_y100
    ...
    if r56 <= (R5+R6):
        ...
        V_y60 = (2 * m5 * v_y50 + v_y60 * (m6 - m5)) / (m6 + m5)
        V_y50 = (2 * m6 * v_y60 + v_y50 * (m5 - m6)) / (m6 + m5)
    else:
        V_x60 = v_x60
        V_x50 = v_x50
        V_y60 = v_y60
    ...
    if r57 <= (R5+R7):
        ...
        V_y70 = (2 * m5 * v_y50 + v_y70 * (m7 - m5)) / (m7 + m5)
        V_y50 = (2 * m7 * v_y70 + v_y50 * (m5 - m7)) / (m7 + m5)
    else:
        V_x70 = v_x70
        V_x50 = v_x50
        V_y70 = v_y70
    ...
    if r58 <= (R5+R8):
        ...
        V_y80 = (2 * m5 * v_y50 + v_y80 * (m8 - m5)) / (m8 + m5)
        V_y50 = (2 * m8 * v_y80 + v_y50 * (m5 - m8)) / (m8 + m5)
    else:
        V_x80 = v_x80
        V_x50 = v_x50
        V_y80 = v_y80
    ...
    if r59<= (R5+R9):
        ...
        V_y90 = (2 * m5 * v_y50 + v_y90 * (m9 - m5)) / (m9 + m5)
        V_y50 = (2 * m9 * v_y90 + v_y50 * (m5 - m9)) / (m9 + m5)
    else:
        V_x90 = v_x90
        V_x50 = v_x50
        V_y90 = v_y90
    ...
    if r510 <= (R5+R10):
        ...
        V_x50 = (2 * m10 * v_x100 + v_x50 * (m5 - m10)) / (m10 + m5)
        V_y100 = (2 * m5 * v_y50 + v_y100 * (m10- m5)) / (m10 + m5)
        V_y50 = (2 * m10 * v_y100 + v_y50 * (m5 - m10)) / (m10 + m5)
    else:
        V_x100 = v_x100
        V_x50 = v_x50
        V_y100 = v_y100
    ...
    if r67 <= (R6+R7):
        ...
        V_y70 = (2 * m6 * v_y60 + v_y70 * (m7 - m6)) / (m7 + m6)
        V_y60 = (2 * m7 * v_y70 + v_y60 * (m6 - m7)) / (m7 + m6)
    else:
        V_x70 = v_x70
        V_x60 = v_x60
        V_y70 = v_y70
    ...
    if r68 <= (R6+R8):
        ...
        V_y80 = (2 * m6 * v_y60 + v_y80 * (m8 - m6)) / (m8 + m6)
        V_y60 = (2 * m8 * v_y80 + v_y60 * (m6 - m8)) / (m8 + m6)
    else:
        V_x80 = v_x80
        V_x60 = v_x60
        V_y80 = v_y80
    ...
    if r69<= (R6+R9):
        ...
        V_y90 = (2 * m6 * v_y60 + v_y90 * (m9 - m6)) / (m9 + m6)
        V_y60 = (2 * m9 * v_y90 + v_y60 * (m6 - m9)) / (m9 + m6)
    else:
        V_x90 = v_x90
        V_x60 = v_x60
        V_y90 = v_y90
    ...
    if r610 <= (R6+R10):
        ...
        V_x60 = (2 * m10 * v_x100 + v_x60 * (m6 - m10)) / (m10 + m6)
        V_y100 = (2 * m6 * v_y60 + v_y100 * (m10- m6)) / (m10 + m6)
        V_y60 = (2 * m10 * v_y100 + v_y60 * (m6 - m10)) / (m10 + m6)
    else:
        V_x100 = v_x100
        V_x60 = v_x60
        V_y100 = v_y100
    ...
    if r78 <= (R7+R8):
        ...
        V_y80 = (2 * m7 * v_y70 + v_y80 * (m8 - m7)) / (m8 + m7)
        V_y70 = (2 * m8 * v_y80 + v_y70 * (m7 - m8)) / (m8 + m7)
    else:
        V_x80 = v_x80
        V_x70 = v_x70
        V_y80 = v_y80
    ...
    if r79<= (R7+R9):
        ...
        V_y90 = (2 * m7 * v_y70 + v_y90 * (m9 - m7)) / (m9 + m7)
        V_y70 = (2 * m9 * v_y90 + v_y70 * (m7 - m9)) / (m9 + m7)
    else:
        V_x90 = v_x90
        V_x70 = v_x70
        V_y90 = v_y90
    ...
    if r710 <= (R7+R10):
        ...
        V_x70 = (2 * m10 * v_x100 + v_x70 * (m7 - m10)) / (m10 + m7)
        V_y100 = (2 * m7 * v_y70 + v_y100 * (m10- m7)) / (m10 + m7)
        V_y70 = (2 * m10 * v_y100 + v_y70 * (m7 - m10)) / (m10 + m7)
    else:
        V_x100 = v_x100
        V_x70 = v_x70
        V_y100 = v_y100
    ...
    if r89<= (R8+R9):
        ...
        V_y90 = (2 * m8 * v_y80 + v_y90 * (m9 - m8)) / (m9 + m8)
        V_y80 = (2 * m9 * v_y90 + v_y80 * (m8 - m9)) / (m9 + m8)
    else:
        V_x90 = v_x90
        V_x80 = v_x80
        V_y90 = v_y90
    ...
    if r810 <= (R8+R10):
        ...
        V_x80 = (2 * m10 * v_x100 + v_x80 * (m8 - m10)) / (m10 + m8)
        V_y100 = (2 * m8 * v_y80 + v_y100 * (m10- m8)) / (m10 + m8)
        V_y80 = (2 * m10 * v_y100 + v_y80 * (m8 - m10)) / (m10 + m8)
    else:
        V_x100 = v_x100
        V_x80 = v_x80
        V_y100 = v_y100
    ...
    if r910 <= (R9+R10):
        ...
        V_x90 = (2 * m10 * v_x100 + v_x90 * (m9 - m10)) / (m10 + m9)
        V_y100 = (2 * m9 * v_y90 + v_y100 * (m10- m9)) / (m10 + m9)
        V_y90 = (2 * m10 * v_y100 + v_y90 * (m9 - m10)) / (m10 + m9)
    else:
        V_x100 = v_x100
        V_x90 = v_x90
        V_y100 = v_y100
...
for i in range(0, len(t), 1):
    body1, = plt.plot(move_array[i, 0], move_array[i, 1], 'o', color='r')
    # body1_line, = plt.plot(move_array[:i, 0], move_array[:i, 1], '-', color='r')

    body2, = plt.plot(move_array[i, 2], move_array[i, 3], 'o', color='g')
    # body2_line, = plt.plot(move_array[:i, 2], move_array[:i, 3], '-', color='g')

    body3, = plt.plot(move_array[i, 4], move_array[i, 5], 'o', color='k')
    # body2_line, = plt.plot(move_array[:i, 2], move_array[:i, 3], '-', color='g')
    
    body4, = plt.plot(move_array[i, 6], move_array[i, 7], 'o', color='r')
                      
                      
    body5, = plt.plot(move_array[i, 8], move_array[i, 9], 'o', color='r')
    
    
    body6, = plt.plot(move_array[i, 10], move_array[i, 11], 'o', color='r')
    
    
    body7, = plt.plot(move_array[i, 12], move_array[i, 13], 'o', color='r')
    
    
    body8, = plt.plot(move_array[i, 14], move_array[i, 15], 'o', color='r')
    
    
    body9, = plt.plot(move_array[i, 16], move_array[i, 17], 'o', color='r')
    
    
    body10, = plt.plot(move_array[i, 18], move_array[i, 19], 'o', color='r')
                      

    bodys.append([body1, body2, body3, body4, body5, body6, body7, body8, body9, body10])

ani = ArtistAnimation(fig, bodys, interval=0.05)

#plt.axis('equal')

ani.save('ПЛАНЕТЫ1111111112.gif')
plt.show()
